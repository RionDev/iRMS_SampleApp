...
export const CSV_COLUMNS: CsvColumnDef[] = [
  { key: 'sha256', label: 'SHA256', group: '기본 정보', get: (s) => s.sha256 },
  { key: 'md5', label: 'MD5', group: '기본 정보', get: (s) => s.md5 },
  { key: 'ssdeep', label: 'SSDEEP', group: '기본 정보', get: (s) => s.ssdeep },
  { key: 'file_size', label: '크기(bytes)', group: '기본 정보', get: (s) => s.file_size },
  { key: 'format', label: '포맷', group: '파일 타입', get: (s) => s.format },
  { key: 'category', label: '카테고리', group: '파일 타입', get: (s) => s.category },
  { key: 'spectype', label: '세부 타입', group: '파일 타입', get: (s) => s.spectype },
  { key: 'compiler', label: '컴파일러', group: '파일 타입', get: (s) => s.compiler },
  { key: 'linker', label: '링커', group: '파일 타입', get: (s) => s.linker },
  { key: 'library', label: '라이브러리', group: '파일 타입', get: (s) => s.library },
  { key: 'crypter', label: '크립터', group: '파일 타입', get: (s) => s.crypter },
  { key: 'overlay', label: '오버레이', group: '파일 타입', get: (s) => s.overlay },
  { key: 'resource', label: '리소스', group: '파일 타입', get: (s) => s.resource },
...
/** 표시 순서를 유지한 그룹 목록 */
export const CSV_GROUPS: CsvGroup[] = ['기본 정보', '파일 타입', '진단', '분류', '메타'];
